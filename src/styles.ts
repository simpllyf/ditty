...
export const STYLES = {
  peppy: {
    ...
    rootMidi: [57, 64],
    instruments: {
      lead: ["pluck", "marimba", "squareLead", "synthBrass"],
      pad: ["warmPad", "glassPad", "organ", "strings"],
      arp: ["pluck", "bell", "musicBox", "glockenspiel"],
  ...
  calm: {
    ...
    rootMidi: [55, 62],
    instruments: {
      lead: ["sineLead", "marimba", "epiano", "airLead", "clarinet", "strings"],
      pad: ["warmPad", "glassPad", "epiano", "strings"],
      arp: ["musicBox", "bell", "glockenspiel"],
      bass: ["subBass", "roundBass"],
    },
  },
  playful: {
    ...
    rootMidi: [57, 64],
    instruments: {
      lead: ["squareLead", "pluck", "synthArp", "synthBrass"],
      pad: ["organ", "glassPad", "strings"],
      arp: ["synthArp", "pluck", "musicBox", "glockenspiel"],
  ...
  dreamy: {
    ...
    instruments: {
      lead: ["sineLead", "marimba", "epiano", "airLead", "clarinet", "strings"],
      pad: ["glassPad", "warmPad", "epiano", "strings"],
      arp: ["bell", "musicBox", "glockenspiel"],
      bass: ["subBass", "roundBass"],
    },
  },
